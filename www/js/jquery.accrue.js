    ...
    var calculateAmortization = function( elem, options, output_elem ){
        ...
        if ( loan_info!==0 ) {
            ...
            var output_content = '<table class="accrue-amortization">'+
                    ...
                    '<th class="accrue-payment-amount">Paument Amt.</th>'+
                    '<th class="accrue-total-interest">Interest Total</th>'+
                    '<th class="accrue-total-payments">Payments Total</th>'+
